...
class Trainer(object):
    ...
    :param optKwargs: (optional) kwargs passed to the learning rate (momentum opt) and to the optimizer
    ...
    def _initialize(self, training_iters, output_path, restore, prediction_path):
        ...
        self.norm_gradients_node = tf.Variable(tf.constant(0.0, shape=[len(self.net.gradientsNode)]))
